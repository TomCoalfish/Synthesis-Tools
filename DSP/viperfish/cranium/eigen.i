/*
This is the basic wrapper.
Not everything will be swig'd in Eigen it is very complicated.
If you have some functions that can be swig'd you can add them 
to your interface in C++ for your script language to call.
*/
%module se
%{
#include "Eigen.h"
...
%inline %{
Eigen::MatrixXd MatrixXd(SimpleEigen::Matrix<double> & m)
{
    Eigen::MatrixXd r;
    r = (m.matrix);
    return r;
